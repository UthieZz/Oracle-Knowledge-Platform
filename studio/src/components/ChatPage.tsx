...
import { Send, User, Bot, ExternalLink, Loader2, Key, Trash2, ShieldCheck, AlertCircle, Sparkles, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto h-[calc(100vh-210px)] flex flex-col bg-gray-950 rounded-2xl border border-gray-800 shadow-2xl overflow-hidden">
      ...
      <div className="px-6 py-3 bg-gray-900/60 border-b border-gray-800 flex justify-between items-center text-xs">
        <div className="flex items-center gap-2 text-gray-400">
          ...
          <span className="text-gray-500 font-mono">Gemini 2.0 Flash</span>
        </div>
            ...
            {!hasKey && (
              <div className="bg-amber-950/40 border border-amber-800/60 p-4 rounded-xl max-w-md w-full mb-6 text-left">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-amber-300 uppercase tracking-wider">Gemini API Key Required</h4>
                    <p className="text-xs text-gray-400 mt-1">
                      Configure your Google AI Studio API key in Settings to activate grounded reasoning.
                    </p>
                    {onOpenSettings && (
                      <button
                        onClick={onOpenSettings}
        ...
        {isLoading && (
          <div className="flex gap-3.5 justify-start">
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-2xl rounded-tl-none p-4 flex items-center gap-2.5">
              ...
              <span className="text-gray-400 text-xs italic">Retrieving evidence and compiling grounded answer...</span>
            </div>
          </div>
        )}
      </div>
